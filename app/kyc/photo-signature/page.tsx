...
export default function PhotoSignaturePage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#EEF4FF] to-white pb-14 px-4 sm:px-6">
      ...
      {/* CARD */}
      <div className="max-w-3xl mx-auto mt-6 bg-white rounded-2xl border border-slate-200 shadow-xl 
      p-6 sm:p-8 md:p-10 space-y-10">
        ...
        <div>
          ...
          {photoPreview && (
            <img
              src={photoPreview}
              className="max-h-48 sm:max-h-64 w-full rounded-xl border border-slate-200 
              shadow-md object-contain mt-3"
            />
          )}
        </div>
            ...
            <div className="flex flex-col items-center space-y-3">
              ...
              {files.signature ? (
                ...
                <>
                  ...
                  <span className="text-xs text-slate-500">
                    Sign on white paper or upload a digital signature
                  </span>
                  <span className="text-xs text-slate-500">
                    JPEG or PNG (Max 1MB)
                  </span>
        ...
        <div className="rounded-xl bg-blue-50 border border-blue-100 p-4 text-sm">
          ...
          <ul className="text-slate-600 space-y-1">
            <li>• Photo should be recent (last 3 months)</li>
            <li>• White or light background preferred</li>
            <li>• Signature should be clear and match official documents</li>
          </ul>
        </div>
