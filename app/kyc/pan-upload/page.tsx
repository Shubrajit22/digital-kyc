...
export default function PanUploadPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#EEF4FF] to-white pb-14 px-4 sm:px-6">
      ...
      {/* CARD */}
      <div className="max-w-3xl mx-auto mt-6 bg-white rounded-2xl border border-slate-200 
      shadow-xl p-6 sm:p-8 md:p-10 space-y-10">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            onChange={(e) => setDetails({ ...details, panNumber: e.target.value })}
            className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-slate-900
            focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition text-sm sm:text-base"
          />
        </div>
        ...
        <div>
          ...
          >
            ...
            <div className="flex flex-col items-center space-y-3">
              ...
              {files.pan ? (
                <span className="font-medium text-blue-600 break-all text-sm">
                  {files.pan.name}
                </span>
              ) : (
                <>
        ...
        {preview && (
          <img
            src={preview}
            className="mt-3 max-h-48 sm:max-h-64 w-full rounded-xl border border-slate-200 
        ...
        <div className="rounded-xl bg-blue-50 border border-blue-100 p-4 text-sm">
          ...
          <span className="text-slate-600">
            Ensure the PAN details are clearly visible and match your provided information.
          </span>
        </div>
