...
export default function ReviewPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#EEF4FF] to-white pb-10">
      ...
      <div className="max-w-4xl mx-auto mt-6 bg-white rounded-2xl border border-slate-200 shadow-xl p-8 md:p-10 space-y-10">
        {/* Heading */}
        <div>
        ...
        <section className="bg-blue-50/60 border border-blue-100 rounded-2xl p-6 space-y-5">
          <h3 className="text-lg font-semibold text-blue-900 flex items-center gap-2">
            <svg className="w-6 h-6 text-blue-700" fill="none" strokeWidth="2" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid md:grid-cols-2 gap-y-4 gap-x-10">
            ...
            <div>
              ...
              <p className="font-semibold text-slate-900">{details.email}</p>
            </div>

            <div>
              <p className="text-xs text-slate-500">Mobile Number</p>
              <p className="font-semibold text-slate-900">{details.phone}</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-blue-50/60 border border-blue-100 rounded-2xl p-6 space-y-5">
          ...
          <div className="grid md:grid-cols-2 gap-y-4 gap-x-10">
            <div>
              ...
              <p className="font-semibold text-slate-900">{details.aadhaarNumber || "—"}</p> {/* ✅ */}
            </div>

            <div>
              <p className="text-xs text-slate-500">Front Side</p>
              <p className="font-semibold text-blue-900 flex items-center gap-1">
                <CheckIcon /> {files.aadhaarFront?.name}
              </p>
            </div>

            <div>
              <p className="text-xs text-slate-500">Back Side</p>
              <p className="font-semibold text-blue-900 flex items-center gap-1">
                <CheckIcon /> {files.aadhaarBack?.name}
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-blue-50/60 border border-blue-100 rounded-2xl p-6 space-y-5">
          ...
          <div className="grid md:grid-cols-2 gap-y-4 gap-x-10">
            <div>
              <p className="text-xs text-slate-500">Photograph</p>
              <p className="font-semibold text-blue-900 flex items-center gap-1">
                <CheckIcon /> {files.photo?.name}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="font-semibold text-blue-900 flex items-center gap-1">
                <CheckIcon /> {files.signature?.name}
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="flex justify-between pt-4">
          <button
            ...
            className="flex items-center cursor-pointer gap-2 px-6 py-2.5 rounded-xl border border-slate-300 bg-white text-slate-700 hover:bg-slate-50 transition shadow"
          >
            ← Back
          </button>
          ...
          <button
            ...
            bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-500 hover:to-blue-600 flex items-center gap-2"
          >
            {loading ? (
              <span className="animate-spin cursor-pointer  h-5 w-5 border-2 border-white border-t-transparent rounded-full"></span>
            ) : (
              <>Submit KYC →</>
            )}
          </button>
